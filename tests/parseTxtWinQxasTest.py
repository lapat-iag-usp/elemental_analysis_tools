...
class Test_parseTxtWinQxas(unittest.TestCase):
    ...
    def test_14(self):
        self.assertEqual(parseTxtWinQxas(file_content)['K']['peaks'][14],38268+171)
        self.assertEqual(parseTxtWinQxas(file_content)['K']['errors'][14],math.sqrt(282**2+298**2))
    ...
    def test_42(self):
        self.assertEqual(parseTxtWinQxas(file2_content)['K']['peaks'][42],372924+2236)
        self.assertEqual(parseTxtWinQxas(file2_content)['L']['peaks'][42],30490+5882)
        self.assertEqual(parseTxtWinQxas(file2_content)['K']['errors'][42],math.sqrt(625**2+115**2))
        self.assertEqual(parseTxtWinQxas(file2_content)['L']['errors'][42],math.sqrt(293**2+389**2))
